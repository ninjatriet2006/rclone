...
exp_special_trash_view: "Xem thùng rác (drive-trashed-only)"
exp_special_trash_exit: "Thoát xem thùng rác"
exp_special_trash_untrash: "Khôi phục mục đang chọn từ thùng rác (untrash)"
...
conn_wizard_zoho_region_title: " BƯỚC 3.1: CHỌN PHÂN VÙNG ZOHO ({}) "
conn_wizard_zoho_region_prompt: "Chọn phân vùng (Region) tài khoản Zoho của bạn để tiến hành xác thực:"
...
exp_special_trash_view: "View Trash Bin (drive-trashed-only)"
exp_special_trash_exit: "Exit Trash Bin View"
exp_special_trash_untrash: "Restore selected item from trash bin (untrash)"
...
conn_wizard_zoho_region_title: " STEP 3.1: SELECT ZOHO REGION ({}) "
conn_wizard_zoho_region_prompt: "Select the region of your Zoho account to begin authentication:"
