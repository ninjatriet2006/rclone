...
help_navigation: "[Up/Down] Di chuyển | [Enter] Chọn/Sửa | [Backspace] Xóa tham số | [Ctrl+S] Lưu | [ESC] Hủy & Quay lại"
...
conn_wizard_edit_save: "[Ctrl+S] LƯU THAY ĐỔI"
conn_wizard_edit_cancel: "[ESC] QUAY LẠI"
conn_remote_name_label: "Tên Remote (Remote Name)"

# File Explorer
exp_help: "[Tab] Đổi khung | [Enter/BS] Vào/Lùi | [Ctrl+R] Remote | [Ctrl+Y] Đổi tên | [Ctrl+C/V] Sao chép/Dán | [Space] Hủy lệnh chờ | [Ctrl+X] Move | [Delete] Xóa | [Alt+N] Tạo mới | [Ctrl+T] Đồng bộ | [Insert] Chọn | [Ctrl+O] Đặc biệt | [ESC] Quay lại"
...
srv_help_edit: "[Tab/Mũi tên Trái/Phải] Đổi Tab | [Mũi tên Lên/Xuống] Di chuyển trường | [Enter] Sửa | [Ctrl+S] Lưu | [Delete] Xóa khóa (Tab Nâng cao) | [Insert] Thêm khóa (Tab Nâng cao) | [ESC] Hủy"
...
srv_browser_help: " [Up/Down] Di chuyển | [Enter] Vào thư mục | [Insert] Chọn thư mục này làm ĐÍCH | [Alt+N] Tạo thư mục con | [ESC] Thoát"
...
srv_systemd_edit_save: "[Ctrl+S] LƯU THAY ĐỔI / KHỞI TẠO"
...
help_navigation: "[Up/Down] Move | [Enter] Select/Edit | [Backspace] Delete parameter | [Ctrl+S] Save | [ESC] Cancel & Back"
...
conn_wizard_edit_save: "[Ctrl+S] SAVE CHANGES"
conn_wizard_edit_cancel: "[ESC] BACK"
conn_remote_name_label: "Remote Name"

# File Explorer
exp_help: "[Tab] Switch pane | [Enter/BS] Enter/Back | [Ctrl+R] Remote | [Ctrl+Y] Rename | [Ctrl+C/V] Copy/Paste | [Space] Cancel pending | [Ctrl+X] Move | [Delete] Delete | [Alt+N] New folder | [Ctrl+T] Sync | [Insert] Select | [Ctrl+O] Special | [ESC] Back"
...
srv_help_edit: "[Tab/Arrows] Switch Tab | [Up/Down] Move field | [Enter] Edit | [Ctrl+S] Save | [Delete] Delete key (Adv Tab) | [Insert] Add key (Adv Tab) | [ESC] Cancel"
...
srv_browser_help: " [Up/Down] Move | [Enter] Enter dir | [Insert] Select this dir as TARGET | [Alt+N] Create folder | [ESC] Exit"
...
srv_systemd_edit_save: "[Ctrl+S] SAVE CHANGES / INITIALIZE"
...
fn merge_missing_keys(path: &std::path::Path, defaults: &str) {
    ...
    if let Ok(default_map) = serde_yaml::from_str::<HashMap<String, String>>(defaults) {
        ...
        for (k, v) in default_map {
            let is_help_key = k.ends_with("_help") || k == "conn_help_navigation" || k == "mon_help" || k == "prof_help" || k == "prof_help_wizard";
